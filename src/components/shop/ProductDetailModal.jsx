...
export const ProductDetailModal = ({ product, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Card */}
      <div className="relative bg-white rounded-3xl max-w-2xl w-full shadow-2xl border border-slate-100 overflow-hidden z-10 animate-slide-up flex flex-col md:flex-row max-h-[90vh]">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-20 p-2 rounded-xl bg-white/80 hover:bg-slate-100 text-slate-500 shadow-sm transition"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="p-6 md:w-1/2 flex flex-col justify-between overflow-y-auto">
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center border border-slate-200 rounded-xl overflow-hidden bg-white">
                  ...
                  <button
                    ...
                    className="p-2 text-slate-600 hover:bg-slate-100 disabled:opacity-30"
                  >
            ...
            <button
              ...
              onClick={handleAdd}
              className={`w-full py-3.5 px-4 rounded-xl font-bold text-sm flex items-center justify-center gap-2 shadow-lg transition ${
