    ...
    <div className="min-h-screen bg-slate-50 py-6 sm:py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-xs text-slate-500 mb-4">
          ...
          <span>/</span>
          <span className="font-bold text-rose-600">{t('wishlist.breadcrumb')}</span>
        </nav>

        {/* Page Header */}
        <div className="bg-white rounded-3xl border border-slate-200/80 p-5 sm:p-6 mb-6 shadow-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-black text-slate-900 flex items-center gap-2.5">
                  ...
                  <span className="text-xs px-2.5 py-1 rounded-full bg-rose-50 text-rose-700 font-extrabold border border-rose-200">
            ...
            {wishlistedProducts.length > 0 && (
              <div className="flex items-center gap-2.5 flex-wrap">
                ...
                <button
                  ...
                  className="px-3.5 py-2.5 rounded-xl border border-slate-200 hover:border-rose-300 text-slate-600 hover:text-rose-600 bg-white hover:bg-rose-50/50 font-bold text-xs transition active:scale-95 flex items-center gap-1.5 cursor-pointer"
        ...
        {isLoading ? (
          ...
          /* Empty State */
          <div className="bg-white rounded-3xl border border-slate-200/80 p-8 sm:p-12 text-center shadow-sm">
            <div className="w-20 h-20 rounded-full bg-rose-50 border border-rose-100 flex items-center justify-center mx-auto mb-4 text-rose-400">
